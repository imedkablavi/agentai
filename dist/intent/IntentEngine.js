...
class IntentEngine {
    ...
    calculatePatternConfidence(text, pattern, match) {
    ...
    inferFollowUpIntent(text, context, language) {
    ...
    getLastLanguageFromHistory(context) {
